                ...
                stage ('Build Docker Image') {
                    steps {
                       ...
                       //bat label: '', script: 'docker build -t webapp:webapp "C:\\\\Program Files (x86)\\\\Jenkins\\\\workspace\\\\devops-quick-course-dockerfile-day4'
                          C:\\Windows\\System32\\WindowsPowerShell\v1.0\\powershell.exe label: '', script: 'docker build -t webapp:webapp "C:\\Program Files (x86)\\Jenkins\\workspace\\devops-quick-course-dockerfile-day4"'
                        }
                  }      
              }
